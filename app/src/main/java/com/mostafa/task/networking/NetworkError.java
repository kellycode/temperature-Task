...
public class NetworkError extends Throwable {
    public static final String DEFAULT_ERROR_MESSAGE = "No City with this name! Please try again.";
    public static final String NETWORK_ERROR_MESSAGE = "No Saved Data And No Internet Connection!";
